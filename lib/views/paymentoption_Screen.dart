...
class paymentoption_Screen extends StatefulWidget {
  const paymentoption_Screen({Key? key}) : super(key: key);

  @override
  State<paymentoption_Screen> createState() => _paymentoption_ScreenState();
}

class _paymentoption_ScreenState extends State<paymentoption_Screen> {
  ///================================================================================///
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text(' Paypal Payment Options',
                style: TextStyle(
