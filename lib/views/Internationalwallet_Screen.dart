...
class Internationalwallet_Screen extends StatefulWidget {
  const Internationalwallet_Screen({Key? key}) : super(key: key);

  @override
  State<Internationalwallet_Screen> createState() =>
      _Internationalwallet_ScreenState();
}

class _Internationalwallet_ScreenState
    extends State<Internationalwallet_Screen> {
  ///================================================================================///
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text('How To international wallet works?',
                style: TextStyle(
