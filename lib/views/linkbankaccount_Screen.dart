...
class linkbankaccount_Screen extends StatefulWidget {
  const linkbankaccount_Screen({Key? key}) : super(key: key);

  @override
  State<linkbankaccount_Screen> createState() => _linkbankaccount_ScreenState();
}

class _linkbankaccount_ScreenState extends State<linkbankaccount_Screen> {
  ///================================================================================///
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text('How To Link Bank Account With Paypal Account?',
                style: TextStyle(
