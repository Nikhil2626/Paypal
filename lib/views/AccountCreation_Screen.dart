...
class AccountCreation_Screen extends StatefulWidget {
  const AccountCreation_Screen({Key? key}) : super(key: key);

  @override
  State<AccountCreation_Screen> createState() => _AccountCreation_ScreenState();
}

class _AccountCreation_ScreenState extends State<AccountCreation_Screen> {
  ///================================================================================///
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('* Paypal Account Creation Guide',
                          style: TextStyle(
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 10),
                        child: Text(
                            'Open your web browser and go to            the       paypal                     website (www.paypal.com)',
                            textAlign: TextAlign.start,
                            textScaleFactor: 1,
                            style: TextStyle(
                                fontWeight: FontWeight.w300,
