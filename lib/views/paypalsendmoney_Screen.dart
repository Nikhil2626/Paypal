...
class paypalsendmoney_Sreen extends StatefulWidget {
  const paypalsendmoney_Sreen({Key? key}) : super(key: key);

  @override
  State<paypalsendmoney_Sreen> createState() => _paypalsendmoney_SreenState();
}

class _paypalsendmoney_SreenState extends State<paypalsendmoney_Sreen> {
  ///================================================================================///
