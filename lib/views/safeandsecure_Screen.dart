...
class safeandsecure_Screen extends StatefulWidget {
  const safeandsecure_Screen({Key? key}) : super(key: key);

  @override
  State<safeandsecure_Screen> createState() => _safeandsecure_ScreenState();
}

class _safeandsecure_ScreenState extends State<safeandsecure_Screen> {
  ///================================================================================///
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text('Is Paypal Safe And Secure?',
                style: TextStyle(
