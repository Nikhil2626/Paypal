...
class moneytransferfees_Screen extends StatefulWidget {
  const moneytransferfees_Screen({Key? key}) : super(key: key);

  @override
  State<moneytransferfees_Screen> createState() =>
      _moneytransferfees_ScreenState();
}

class _moneytransferfees_ScreenState extends State<moneytransferfees_Screen> {
  ///================================================================================///
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text('Paypal Money Transder Fees?',
                style: TextStyle(
