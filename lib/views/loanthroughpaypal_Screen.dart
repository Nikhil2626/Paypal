...
class loanthroughpaypal_Screen extends StatefulWidget {
  const loanthroughpaypal_Screen({Key? key}) : super(key: key);

  @override
  State<loanthroughpaypal_Screen> createState() =>
      _loanthroughpaypal_ScreenState();
}

class _loanthroughpaypal_ScreenState extends State<loanthroughpaypal_Screen> {
  @override
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text('Getting A Loan Through Paypal?',
                style: TextStyle(
