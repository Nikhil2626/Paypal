...
class benifitsofpaypal_Screen extends StatefulWidget {
  const benifitsofpaypal_Screen({Key? key}) : super(key: key);

  @override
  State<benifitsofpaypal_Screen> createState() =>
      _benifitsofpaypal_ScreenState();
}

class _benifitsofpaypal_ScreenState extends State<benifitsofpaypal_Screen> {
  ///================================================================================///
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text('What Are The Benefits Of Paypal?',
                style: TextStyle(
