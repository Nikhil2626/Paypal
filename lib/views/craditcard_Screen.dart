...
class craditcard_Screen extends StatefulWidget {
  const craditcard_Screen({Key? key}) : super(key: key);

  @override
  State<craditcard_Screen> createState() => _craditcard_ScreenState();
}

class _craditcard_ScreenState extends State<craditcard_Screen> {
  ///================================================================================///
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text('How To Add A Bank Account Or Credit Card To Paypal',
                style: TextStyle(
