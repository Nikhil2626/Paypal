...
class howtoaddmoney_Screen extends StatefulWidget {
  const howtoaddmoney_Screen({Key? key}) : super(key: key);

  @override
  State<howtoaddmoney_Screen> createState() => _howtoaddmoney_ScreenState();
}

class _howtoaddmoney_ScreenState extends State<howtoaddmoney_Screen> {
  ///================================================================================///
