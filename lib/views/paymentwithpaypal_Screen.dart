...
class paymentwithpaypal_Screen extends StatefulWidget {
  const paymentwithpaypal_Screen({Key? key}) : super(key: key);

  @override
  State<paymentwithpaypal_Screen> createState() =>
      _paymentwithpaypal_ScreenState();
}

class _paymentwithpaypal_ScreenState extends State<paymentwithpaypal_Screen> {
  ///================================================================================///
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text('Payments With Paypal',
                style: TextStyle(
