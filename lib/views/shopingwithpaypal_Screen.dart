...
class shopingwithpaypal_Screen extends StatefulWidget {
  const shopingwithpaypal_Screen({Key? key}) : super(key: key);

  @override
  State<shopingwithpaypal_Screen> createState() =>
      _shopingwithpaypal_ScreenState();
}

class _shopingwithpaypal_ScreenState extends State<shopingwithpaypal_Screen> {
  ///================================================================================///
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text('Online Shopping With Paypal.',
                style: TextStyle(
