...
class instantcash_Screen extends StatefulWidget {
  const instantcash_Screen({Key? key}) : super(key: key);

  @override
  State<instantcash_Screen> createState() => _instantcash_ScreenState();
}

class _instantcash_ScreenState extends State<instantcash_Screen> {
  ///================================================================================///
      ...
      body: Column(
        children: [
          AppBar(
            ...
            title: Text('How To Get Instant Cash?',
                style: TextStyle(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Text(
                            '* You can count on Instant Transfer Transfer your money in a few easy steps',
                            style: TextStyle(
